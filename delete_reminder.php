...
<body><div class="disable-reminder">
        ...
        <form>
          ...
          Select a date:
            ...
            <input type="name" id="url" class="form-control" name="url" value="<?php echo URL_ROOT."delete_reminder.php?date=";?>" hidden>
...
$("form").submit(function(event){
	$.ajax({
		url : 'ajax.php',
		type: 'POST',
		data : $(this).serialize()+"&id="+$('#reminder').val()+"&action=delete_reminder",
    dataType: 'json',
    encode : true,
	}).done(function(data){ 
    if(data.status == 1){
